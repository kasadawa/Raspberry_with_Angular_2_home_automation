...
export class AddDevicesComponent implements  OnInit{
    ...
    deviceName= ''; // used in the .html file
    itemTypes = ['lamp','switch','contact','relay'];
    raspiPins:any = []; // those pins are declared in index.js
    ...
    addDevice(name:string){
        ...
        (<HTMLInputElement>document.getElementById("device-name")).value = '';  
    }
